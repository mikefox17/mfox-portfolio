...
var CreateDocumentDialog = /*#__PURE__*/(0, _react.memo)(_ref => {
  ...
  var content = newDocumentOptions.length <= 0 ? /*#__PURE__*/_react.default.createElement(_ui.Box, {
    ...
    var _templatePermissions$;

    var granted = Boolean(!isTemplatePermissionsLoading && (templatePermissions === null || templatePermissions === void 0 ? void 0 : (_templatePermissions$ = templatePermissions[item.id]) === null || _templatePermissions$ === void 0 ? void 0 : _templatePermissions$.granted));
